                ...
                <div key={agent.id} className="card flex items-start sm:items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {(agent as any).testMode && <span className="text-[14px] bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-300 px-1.5 py-0.5 rounded-full font-medium shrink-0">🧪 Teste</span>}
                    </div>
