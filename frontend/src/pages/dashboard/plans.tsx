...
const SKILLS: SkillDef[] = [
  ...
  {
    id: 'vendas',
    name: 'Vendas Proativas',
    icon: '🏷️',
    category: 'revenue',
    desc: 'O agente identifica oportunidades e oferece produtos ativamente',
    detail: 'O agente não espera — identifica o contexto da conversa e sugere produtos ou serviços relevantes de forma proativa, com base no histórico e preferências do cliente.',
    plans: { free: 'unavailable', starter: 'addon', business: 'included', enterprise: 'included' },
    addonPrice: { starter: 20 },
  },
  {
    id: 'upselling',
    name: 'Upselling / Cross-sell',
    icon: '📈',
    category: 'revenue',
    desc: 'Sugere upgrades e produtos complementares durante o pedido',
    detail: 'Quando o cliente está a fazer um pedido, o agente sugere naturalmente itens adicionais, tamanhos maiores ou produtos complementares. Ex: "Quer adicionar uma bebida ao pedido?".',
    plans: { free: 'unavailable', starter: 'addon', business: 'included', enterprise: 'included' },
    addonPrice: { starter: 20 },
  },
  {
